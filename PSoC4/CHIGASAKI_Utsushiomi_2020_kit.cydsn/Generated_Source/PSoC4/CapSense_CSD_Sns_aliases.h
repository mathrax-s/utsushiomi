...
#define CapSense_CSD_Sns_13			(CapSense_CSD_Sns__13__PC)
#define CapSense_CSD_Sns_13_PS		(CapSense_CSD_Sns__13__PS)
#define CapSense_CSD_Sns_13_PC		(CapSense_CSD_Sns__13__PC)
#define CapSense_CSD_Sns_13_DR		(CapSense_CSD_Sns__13__DR)
#define CapSense_CSD_Sns_13_SHIFT	(CapSense_CSD_Sns__13__SHIFT)
#define CapSense_CSD_Sns_13_INTR	((uint16)((uint16)0x0003u << (CapSense_CSD_Sns__13__SHIFT*2u)))

#define CapSense_CSD_Sns_INTR_ALL	 ((uint16)(CapSense_CSD_Sns_0_INTR| CapSense_CSD_Sns_1_INTR| CapSense_CSD_Sns_2_INTR| CapSense_CSD_Sns_3_INTR| CapSense_CSD_Sns_4_INTR| CapSense_CSD_Sns_5_INTR| CapSense_CSD_Sns_6_INTR| CapSense_CSD_Sns_7_INTR| CapSense_CSD_Sns_8_INTR| CapSense_CSD_Sns_9_INTR| CapSense_CSD_Sns_10_INTR| CapSense_CSD_Sns_11_INTR| CapSense_CSD_Sns_12_INTR| CapSense_CSD_Sns_13_INTR))
...
#define CapSense_CSD_Sns_GuardSensor__GRD_INTR	((uint16)((uint16)0x0003u << (CapSense_CSD_Sns__13__SHIFT*2u)))
